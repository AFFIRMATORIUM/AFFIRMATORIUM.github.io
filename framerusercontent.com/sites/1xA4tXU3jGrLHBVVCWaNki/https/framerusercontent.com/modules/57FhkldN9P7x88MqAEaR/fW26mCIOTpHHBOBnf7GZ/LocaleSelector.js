...
import {
    addPropertyControls,
    ControlType, // @ts-ignore Internal function
...
import {
    getBorderStyle,
    borderControls
} from "https://framerusercontent.com/modules/cuKUFdzXlhvw8OVOBeAc/T08RxQJ4qrs7LLc8wx4E/border.js";
import {
    getFocusStyle,
    focusControls
} from "https://framerusercontent.com/modules/9muYaW1MvHoRQJ0P7dkP/V2GVvLqiMxXRSxszkCSa/focus.js";
import {
    getHoverStyle,
    hoverControls
} from "https://framerusercontent.com/modules/YfmtnpWjJrP37sQ18QUZ/9Y2P24U2SBIbf2fPVsOX/hover.js";
import {
    getPaddingStyle,
    paddingControls
} from "https://framerusercontent.com/modules/wjZLfSMaP1TvJDu5PCwr/XQ1GMXuIqYrEN1c0R6E5/padding.js";
import {
    getRadiusStyle,
    radiusControls
} from "https://framerusercontent.com/modules/N6MwtHbWoiZJNn1xpqxu/ZEWmVGYDUhL44tluQO5y/radius.js";
...
function Icon({
    ...
    if (type === "custom" && image) {
        return /*#__PURE__*/ _jsx("img", { ...image,
            width: size,
            height: size
        });
    }
...
const LocaleSelector = withCSS(({
    ...
    const [lastActiveLocaleId, setLastActiveLocaleId] = useState(activeLocaleId); // The useLocaleInfo hook updates the activeLocale variable inside
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [ /*#__PURE__*/ _jsx("label", {
            ...
            onChange: handleChange, // If a navigation occurs from switching locales
            // the browser can attempt to autofill the select to the last value
            // when you use browser back navigation. We don't want that.
            autoComplete: "off",
            children: localesForCurrentRoute.map(locale => /*#__PURE__*/ _jsx("option", {
                value: locale.id,
            ...
            children: [icon && /*#__PURE__*/ _jsx("div", {
                className: "icon",
                children: /*#__PURE__*/ _jsx(Icon, { ...icon
                })
            }), title && /*#__PURE__*/ _jsx("div", {
                className: "title",
                children: selectedLocale ? .name ? ? "English"
            }), caret && /*#__PURE__*/ _jsx("div", {
                className: "caret",
                children: /*#__PURE__*/ _jsx(Caret, { ...caret
                })
            })]
        })]
    });
