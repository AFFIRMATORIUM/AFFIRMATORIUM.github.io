...
var MixedParse = class {
    ...
    stopAt(pos) {
        ...
        if (this.baseParse) this.baseParse.stopAt(pos);
            ...
            for (let i = this.innerDone; i < this.inner.length; i++) this.inner[i].parse.stopAt(pos);
    }
    startInner() {
...
function materialize(cursor) {
    ...
    do {
        ...
        cursor.parent();
    } while (!cursor.tree) let base = cursor.tree,
...
var StructureCursor = class { // Move to the first node (in pre-order) that starts at or after `pos`.
    moveTo(pos) {
        let {
            cursor
