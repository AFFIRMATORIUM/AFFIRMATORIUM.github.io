...
import {
    ...
    Tree,
    IterMode
} from "https://framerusercontent.com/modules/CO9ruPlVDRTCLVInyri7/MGamyd2UebFXXyjBfB8y/lezer_common.js";
var Stack = class _Stack { /// @internal
    toString() {
...
var InputStream = class { /// @internal
...
var ExternalTokenizer = class { /// Create a tokenizer. The first argument is the function that,
...
var id = x => x;
var ContextTracker = class { /// Define a context tracker.
    constructor(spec) {
...
var LRParser = class _LRParser extends Parser {
    ...
    parseDialect(dialect) {
        ...
        for (let i = 0; i < values.length; i++)
            if (!flags[i]) {
                for (let j = this.dialects[values[i]], id2;
                    (id2 = this.data[j++]) != 65535;)(disabled || (disabled = new Uint8Array(this.maxTerm + 1)))[id2] = 1;
            }
