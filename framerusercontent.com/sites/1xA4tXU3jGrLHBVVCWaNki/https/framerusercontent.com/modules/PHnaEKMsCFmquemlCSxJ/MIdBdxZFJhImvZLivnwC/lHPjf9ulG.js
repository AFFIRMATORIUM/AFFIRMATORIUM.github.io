...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const href = useSVGTemplate("130366660", svg);
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-my9st", className),
        layoutId: layoutId,
        ref: ref,
        role: "presentation",
        style: {
...
const css = [`.framer-my9st { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 * @framerVector {"name":"Envelope","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}
 * @framerDisableUnlink true
 */
const Icon = withCSS(Component, css, "framer-my9st");
