...
import {
    ...
    highlightTree,
    styleTags
} from "https://framerusercontent.com/modules/rOWwbZHN39cczduPnzmw/YaHVqqT79imnSnw9WihN/lezer_highlight.js"; // ../../node_modules/style-mod/src/style-mod.js
var C = "ͼ";
        ...
        let explore = (tree, from) => {
            ...
            if (mount) {
                if (mount.tree.prop(languageDataProp) == this.data) {
                    if (mount.overlay)
                        for (let r of mount.overlay) result.push({
                            from: r.from + from,
                            to: r.to + from
                        });
                    else result.push({
...
function matchMarkedBrackets(_state, _pos, dir, token, handle, matching, brackets) {
    ...
    if (cursor && (dir < 0 ? cursor.childBefore(token.from) : cursor.childAfter(token.to)))
        ...
        } while (dir < 0 ? cursor.prevSibling() : cursor.nextSibling()) return {
            start: firstToken,
            matched: false
        };
}
