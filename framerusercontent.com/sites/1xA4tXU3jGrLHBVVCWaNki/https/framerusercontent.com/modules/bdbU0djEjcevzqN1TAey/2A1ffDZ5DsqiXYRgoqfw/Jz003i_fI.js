...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-lGvLP", className),
        layoutId: layoutId,
        ref: ref,
        role: "presentation",
        style: {
...
const css = [`.framer-lGvLP { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 */
const Icon = withCSS(Component, css, "framer-lGvLP");
