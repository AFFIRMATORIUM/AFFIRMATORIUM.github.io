...
fontStore.loadFonts(["GF;Geist-regular", "Inter-Bold", "Inter-BoldItalic", "Inter-Italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Geist",
