...
import {
    ...
    RangeSetBuilder,
    countColumn
} from "https://framerusercontent.com/modules/wFkXxZqfKOPeEQtsYrsa/TWvikt1kG1sKU5G0pMRF/codemirror_state.js"; // ../../node_modules/style-mod/src/style-mod.js
var C = "ͼ";
var COUNT = typeof Symbol == "undefined" ? "__" + C : Symbol.for(C);
var SET = typeof Symbol == "undefined" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet");
var top = typeof globalThis != "undefined" ? globalThis : typeof window != "undefined" ? window : {};
var StyleModule = class { // :: () → string
...
var PointDecoration = class _PointDecoration extends Decoration { // Only relevant when this.block == true
    get type() {
...
var LineView = class _LineView extends ContentView { // Consumes source
    merge(from, to, source, hasStart, openStart, openEnd) {
        if (source) {
...
var baseTheme$1 = /* @__PURE__ */ buildTheme("." + baseThemeID, {
    "&": {
        ...
        "&.cm-focused": { // Provide a simple default outline to make sure a focused
...
var EditorView = class _EditorView {
    ...
    plugin(plugin2) {
        ...
        if (known === void 0 || known && known.spec != plugin2) this.pluginMap.set(plugin2, known = this.plugins.find(p => p.spec == plugin2) || null);
...
var MatchDecorator = class {
    ...
    createDeco(view) {
        ...
        for (let {
                from,
                to
            } of matchRanges(view, this.maxLength)) iterMatches(view.state.doc, this.regexp, from, to, (from2, m) => this.addMatch(m, view, from2, add));
        return build.finish();
    }
    /**
    ...
    maybeMeasure() {
        if (this.manager.tooltips.length) {
            ...
            if (this.inView != this.view.inView) {
                ...
                if (!this.inView)
                    for (let tv of this.manager.tooltipViews) tv.dom.style.top = Outside;
            }
        }
    }
    constructor(view) {
...
var HoverTooltipHost = class _HoverTooltipHost { // Needs to be static so that host tooltip instances always match
    static create(view) {
...
var tabDeco = /* @__PURE__ */ Decoration.mark({
    class: "cm-highlightTab"
});
var spaceDeco = /* @__PURE__ */ Decoration.mark({
